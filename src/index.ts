  ...
  activate: (app: JupyterFrontEnd, manager: IThemeManager) => {
    ...
    manager.register({
      ...
      load: () => {
        ...
        document.documentElement.style.setProperty(
          '--jp-brand-color0',
          'var(--simpledark-green-700)'
        );
        document.documentElement.style.setProperty(
          '--jp-brand-color1',
          'var(--simpledark-green-500)'
        );
        document.documentElement.style.setProperty(
          '--jp-brand-color2',
          'var(--simpledark-green-400)'
        );
        document.documentElement.style.setProperty(
          '--jp-brand-color3',
          'var(--simpledark-green-100)'
        );

        // Theme colors
        document.documentElement.style.setProperty(
          '--simpledark-layout-color0',
          'var(--simpledark-grey-900)'
        );
        document.documentElement.style.setProperty(
          '--simpledark-layout-color1',
          'var(--simpledark-grey-900)'
        );
        document.documentElement.style.setProperty(
          '--simpledark-layout-color2',
          'var(--simpledark-grey-950)'
        );
        document.documentElement.style.setProperty(
          '--simpledark-layout-color3',
          'var(--simpledark-green-500)'
        );
        document.documentElement.style.setProperty(
          '--simpledark-layout-color4',
          'var(--simpledark-grey-400)'
        );
        ...
        // Object & font colors
        document.documentElement.style.setProperty(
          '--simpledark-background-color',
          'rgb(var(--simpledark-black))'
        );
        document.documentElement.style.setProperty(
          '--simpledark-code-cell-color',
          'var(--simpledark-grey-800)'
        );
        document.documentElement.style.setProperty(
          '--simpledark-base-font-color',
          'var(--simpledark-white)'
        );
        document.documentElement.style.setProperty(
          '--simpledark-inverse-font-color',
          'var(--simpledark-black)'
        );
        document.documentElement.style.setProperty(
          '--jp-rendermime-error-background',
          'var(--simpledark-red-900)'
        );

        // Menu color
        document.documentElement.style.setProperty(
          '--simpledark-menu-color',
          'var(--simpledark-grey-900)'
        );
        ...
        document.documentElement.style.setProperty(
          ...
          'var(--simpledark-green-800)'
        );

        // State colors
        document.documentElement.style.setProperty(
          '--jp-info-color0',
          'var(--simpledark-blue-700)'
        );
        document.documentElement.style.setProperty(
          '--jp-info-color1',
          'var(--simpledark-blue-600)'
        );
        document.documentElement.style.setProperty(
          '--jp-info-color2',
          'var(--simpledark-blue-500)'
        );
        document.documentElement.style.setProperty(
          '--jp-info-color3',
          'var(--simpledark-blue-400)'
        );
        ...
        document.documentElement.style.setProperty(
          '--jp-error-color0',
          'var(--simpledark-red-700)'
        );
        document.documentElement.style.setProperty(
          '--jp-error-color1',
          'var(--simpledark-red-500)'
        );
        document.documentElement.style.setProperty(
          '--jp-error-color2',
          'var(--simpledark-red-300)'
        );
        document.documentElement.style.setProperty(
          '--jp-error-color3',
          'var(--simpledark-red-100)'
        );
        ...
        // Scrollbar color
        document.documentElement.style.setProperty(
          '--simpledark-scrollbar-track-color',
          'var(--simpledark-grey-700)'
        );
        document.documentElement.style.setProperty(
          '--simpledark-scrollbar-thumb-color',
          'var(--simpledark-grey-900)'
        );
        ...
        document.documentElement.style.setProperty(
          ...
          'var(--simpledark-blue-900)'
        );

        document.documentElement.style.setProperty(
          '--jp-cell-prompt-not-active-font-color',
          'var(--simpledark-grey-500)'
        );
        document.documentElement.style.setProperty(
        ...
        document.documentElement.style.setProperty(
          ...
          'var(--simpledark-grey-600)'
        );
        document.documentElement.style.setProperty(
          '--jp-rendermime-table-row-hover-background',
          'var(--simpledark-orange-200)'
        );
        document.documentElement.style.setProperty(
          '--jp-rendermime-error-background',
          '#151524'
    ...
    manager.register({
      ...
      load: () => {
        ...
        document.documentElement.style.setProperty(
          '--jp-brand-color2',
          'var(--simpledark-orange-500)'
        );
        document.documentElement.style.setProperty(
          '--jp-brand-color3',
          'var(--simpledark-orange-400)'
        );
        document.documentElement.style.setProperty(
          '--jp-brand-color5',
          'var(--simpledark-orange-300)'
        );

        // Accent colors
        document.documentElement.style.setProperty(
          '--jp-accent-color0',
          'var(--simpledark-indigo-800)'
        );
        document.documentElement.style.setProperty(
          '--jp-accent-color1',
          'var(--simpledark-indigo-700)'
        );
        document.documentElement.style.setProperty(
          '--jp-accent-color2',
          'var(--simpledark-indigo-600)'
        );
        document.documentElement.style.setProperty(
          '--jp-accent-color3',
          'var(--simpledark-indigo-300)'
        );
        ...
        document.documentElement.style.setProperty(
          '--simpledark-layout-color1',
          'var(--simpledark-black-700)'
        );
        document.documentElement.style.setProperty(
          '--simpledark-layout-color2',
          'var(--simpledark-black-500)'
        );
        document.documentElement.style.setProperty(
          '--simpledark-layout-color3',
          'var(--simpledark-orange-500)'
        ...
        document.documentElement.style.setProperty(
          '--simpledark-menu-item-hover-color',
          'var(--simpledark-black-500)'
        );
        ...
        document.documentElement.style.setProperty(
          '--jp-info-color2',
          'var(--simpledark-indigo-500)'
        );
        document.documentElement.style.setProperty(
          '--jp-info-color3',
          'var(--simpledark-indigo-400)'
        );
